...
export function CodenamesClueInputModal({
  ...
  return (
    ...
    >
      <div
        className="bg-white text-slate-900 rounded-3xl max-w-md w-full p-5 sm:p-6 shadow-2xl border border-slate-200 overflow-hidden flex flex-col space-y-4 animate-scale-in"
        ...
        <div className="flex items-center justify-between pb-3 border-b border-slate-100">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 font-medium">Sahadaki ajanlarınıza yön verin</p>
            </div>
          </div>
          <button
            onClick={() => {
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="text-[11px] font-black text-indigo-700 hover:text-indigo-900 flex items-center gap-1 bg-indigo-50 hover:bg-indigo-100 px-2.5 py-1 rounded-lg border border-indigo-200 transition-all cursor-pointer"
              >
                {isAiLoading ? (
            ...
            <input
              ...
              className="w-full bg-slate-50 border-2 border-slate-200 focus:border-indigo-600 rounded-2xl px-4 py-3 text-base font-black text-slate-900 placeholder-slate-400 focus:outline-hidden uppercase tracking-wider"
            />
          </div>
