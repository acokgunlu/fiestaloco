...
export const QuiplashPassAndPlay: React.FC<QuiplashPassAndPlayProps> = ({
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col justify-between p-4 sm:p-6">
      ...
      {/* Main Area */}
      <main className="flex-1 flex flex-col justify-center items-center py-6 max-w-xl mx-auto w-full">
        {/* ============================================================ */}
        {/* 1. SETUP                                                     */}
        {/* ============================================================ */}
        {phase === 'SETUP' && (
              ...
              {playerNames.map((name, i) => (
                <div key={i} className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="flex-1 px-4 py-2.5 rounded-xl bg-slate-950 border border-slate-700 text-white font-bold text-sm"
                  />
        ...
        {phase === 'WRITE_PROMPTS' && isRevealedForWriting && (
          <div className="w-full p-6 rounded-3xl bg-slate-900 border border-slate-800 shadow-2xl space-y-5">
            ...
            {(players[currentWritingPlayerIdx]?.assignedPrompts || []).map((prompt, i) => (
              <div key={prompt.id} className="p-4 rounded-2xl bg-slate-950 border border-slate-800 space-y-2">
                <span className="text-[10px] font-black text-purple-400 uppercase">
                  Soru #{i + 1}
                </span>
                <p className="text-sm font-bold text-white">"{prompt.prompt}"</p>
                <input
                  type="text"
        ...
        {phase === 'GAME_OVER' && (
          <div className="w-full p-8 rounded-3xl bg-slate-900 border border-amber-400/50 shadow-2xl text-center space-y-6">
            ...
            {(() => {
              ...
              return (
                <div className="p-6 rounded-2xl bg-slate-950 border border-amber-400/40">
